...
// CTurbSSTVariable_new::CTurbSSTVariable_new(CGeometry *geometry, su2double kine, su2double omega, su2double mut, unsigned long npoint, unsigned long ndim, unsigned long nvar, const su2double* constants, CConfig *config)
//   : CTurbVariable(npoint, ndim, nvar, config) {
...
// void CTurbSSTVariable_new::SetBlendingFunc(unsigned long iPoint, su2double val_viscosity,
//                                        su2double val_dist, su2double val_density) {
//   su2double arg2, arg2A, arg2B, arg1;
